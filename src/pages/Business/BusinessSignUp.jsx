...
const BusinessSignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newError).length > 0) {
      ...
      setError({});
      navigate("/business/signup/otp/verification");
    }
  };
  ...
  return (
    <div className="">
      <div className="h-fit space-y-[40px] w-[480px] border-[1px] border-[#E4E7EC] rounded-[20px] p-[32px]">
        <h1 className="text-[24px] font-bold text-center">Create an account</h1>
        <form className="space-y-[40px]" onSubmit={handleSubmit}>
          ...
          <div className="space-y-[32px]">
            ...
            <Button full={true} type="primary" title="Create account" />
          </div>
        </form>
      </div>
    </div>
